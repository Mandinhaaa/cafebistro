...
<main>
    ...
    <section class="container-form">
        <form action="processar-cadastro.php" method="post">
            ...
            <input type="password" id=" confirmarsenha" name="confirmarsenha" placeholder="Digite novamente a senha" required>
            <?php if (isset($_GET['erro'])){
                echo "<label for='erro'>Senha e confirmação de senha nao coincidem</label>";
            } ?>
